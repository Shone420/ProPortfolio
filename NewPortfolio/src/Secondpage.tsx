    ...
    <div style={{ background: "#D9D9D9", padding: "15px" }} id="About-section">
      ...
      <div style={{ width: "100%", display: "flex" }}>
        ...
        >
          ...
          unwavering
          <br />
          passion for artwork and product design. The world around me serves as
          <br /> my greatest source of inspiration, with everyday objects,
          patterns, and
          <br />
          even fleeting moments sparking my imagination.
          <br />
          Music also plays a vital role in my creative process, acting as a
          soundtrack
          <br />
          that influences my emotions and design direction. Whether it's through
          <br />
          the rhythm of a song or the emotion behind the melody, music helps
          <br />
          guide my ideas and brings them to life in my work.
        </div>
        <div style={{ width: "20%", display: "relative" }}></div>
      </div>
      <br />
      <br />
